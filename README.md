...
```
git clone https://github.com/0upsz/DataCleaningProject
```
...
* [Алексей Кириллин](https://t.me/Oupsz)

## Выводы

В процессе выполнения работы были получены практические навыки по работе с объектами pandas.DataFrame (работа с пропущенными данными, дубликатами), средствами визуализации библиотек Seaborn и matplotlib. Также было рассмотрено применение методов мат. статистики для выявления выбросов и последующей очистки и анализа данных.